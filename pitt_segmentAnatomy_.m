...
for ii=1:numel(subs)
    ...
    % Check for "working file": if it doesn't exist then write it out here.
    workFile = fullfile(mrdDir,'.segWorking');
    ...
    if ~exist(workFile,'file')
        ...
        disp('Another process is working on this subject. Moving on...');
    end
end
