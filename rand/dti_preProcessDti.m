...
%% Directory and Subject Informatmation
...
for ii=1:numel(subs)
    ...
    % If the nifti files don't exist we create them
...
% Add check for number of scans
    ...
    % Output instruction for running mrAnatAverageAcpcNifti
