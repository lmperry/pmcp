function pitt_fiberTracker(baseDir)
% 
% This will wrap the fs_fiberTracker function

% Get a list of dt6s
% Choose the ROIs and set the paths to those ROIs which will change 

% function subsProc = pitt_fiberTracker(baseDir)
% 
...
%       subsProc  = pitt_fiberTracker(baseDir);
% 
% 

% ********** Make a seperate directory for these fibers ********
% Must analyze the mori groups sperately (I think) - see
% pitt_analyzeFibers.m

%  Author: LMP [2013]
%#ok<*AGROW>

% This is the function that will be called - so need to provide these
% inputs. 
% [fgO ctrF] = fs_fiberTracker(dt6,roi1,roi2,roiDir,trackMethod,wbFg,trackOpts,outDir);
